 ...
 *                   type: string
 */
router.get('/user/:userId', postController_1.default.getPostsByUser);
 ...
 *                   type: string
 */
router.get('/:postId/likes', postController_1.default.getPostLikes);
// Protected routes
 ...
 *                   type: string
 */
router.post('/', uploads_1.uploadImage.single('image'), postController_1.default.createPost);
/**
 * @swagger
 * /posts/{postId}:
 *   put:
 ...
 *                   type: string
 */
router.put('/:postId', uploads_1.uploadImage.single('image'), postController_1.default.updatePost);
 ...
 *                   type: string
 */
router.post('/:postId/like', postController_1.default.toggleLike);
