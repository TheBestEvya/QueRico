 ...
 */
router.get('/allPosts', userController_1.default.getUserPosts);
 ...
 *         description: Internal server error
 */
router.get('/', userController_1.default.getProfile);
/**
 * @swagger
 * /users/update:
 *   post:
 ...
 *         description: Internal server error
 */
router.post('/update', uploads_1.uploadImage.single('profileImage'), userController_1.default.updateProfile);
/**
 * @swagger
 * /users/delete:
 *   delete:
 ...
 *         description: Internal server error
 */
router.delete('/delete', userController_1.default.deleteProfile);
